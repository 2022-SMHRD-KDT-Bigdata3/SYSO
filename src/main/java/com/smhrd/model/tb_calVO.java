...
public class tb_calVO {
	...
	public tb_calVO(String user_id, String title, String content) {
		super();
	...
	public tb_calVO(int calendar_seq, String user_id, String title, String writer, String content, String start1,
			String end1, boolean allday, String textColor, String backgroundColor, String borderColor) {
		super();
		this.calendar_seq = calendar_seq;
		this.user_id = user_id;
		this.title = title;
